...
async def generate_sql(req: QueryRequest):
    ...
    try:
        ...
        print("🔹 [STEP 2] Raw LLM response type:", type(llm_response))
        print("🔹 [STEP 3] Raw LLM response content:", repr(llm_response))
    ...
    print("🔹 [STEP 4] SQL generated:", sql_code)
    print("🔹 [STEP 5] Explanation:", explanation)

    if not sql_code:
        print("⚠️ [WARNING] No SQL generated by LLM")
